"""
Logging configuration for MailMaestro.
...
LOG_DIR = os.getenv("MAILMAESTRO_LOG_DIR", "logs")
os.makedirs(LOG_DIR, exist_ok=True)
LOG_LEVEL = os.getenv("MAILMAESTRO_LOG_LEVEL", "DEBUG").upper()
...
LOGGING_CONFIG = {
    ...
    'handlers': {
        'email_client_file': {
            ...
            'filename': log_path('email_client'),
            'formatter': 'standard',
            'encoding': 'utf8',
        },
        'runner_file': {
    ...
    'loggers': {
        'mailmaestro.services.email_client': {
            'handlers': ['email_client_file'],
            'level': LOG_LEVEL,
            'propagate': False,
        },
        'mailmaestro.runner': {
